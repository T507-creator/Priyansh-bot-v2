...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("@Thataone")==0 || event.body.indexOf("@Thataomez😸⚜️")==0 || event.body.indexOf("@Thataone Duka williams")==0 || event.body.indexOf("Thataone")==0) {
		var msg = {
				body: "Thataone ✨💖🥀",
				attachment: fs.createReadStream(__dirname + `/noprefix/Thatane.png`)
			}
